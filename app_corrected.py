...
def ocr_mindee(pdf_file):
    # Mise à jour de l'URL pour le produit "mindee invoices"
    url = "https://api.mindee.net/v1/products/mindee/invoices/v4/predict"  # URL corrigée pour Mindee Invoice OCR
    headers = {
